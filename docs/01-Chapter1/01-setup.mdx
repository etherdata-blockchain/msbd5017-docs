...
import InstallNodeTerminal from "../../src/components/Chapter1/InstallNodeTerminal";
import PnpmInitTerminal from "../../src/components/Chapter1/PnpmInitTerminal";
import NpmInitTerminal from "../../src/components/Chapter1/NpmInitTerminal";
import YarnInitTerminal from "../../src/components/Chapter1/YarnInitTerminal";
...
:::info
You can download the complete code for this section [here](https://files.etdchain.net/setup_wallet_sample_code.zip)
:::
