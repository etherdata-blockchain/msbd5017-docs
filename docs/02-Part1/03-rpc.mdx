---
title: Connect to the Web3 network
---

In this class, we provide two endpoints for you to deploy your smart contracts to the 
etherdata blockchain network.

- Production endpoint: https://rpc.etdchain.net, Chain id: 3101
- Testnet endpoint: https://rpc.debugchain.net, Chain id: 8348
...
<iframe src="https://codesandbox.io/embed/web3-connect-0ngc1e?expanddevtools=1&fontsize=14&hidenavigation=1&theme=dark&view=editor"
