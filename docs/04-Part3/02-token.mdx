...
import DeployContract from "../../src/components/part3/DeployContract";
...
You should follow [Part 2](/Part2/setup) to setup your environment.
...
Keep in mind that since we installed the [OpenZeppelin framework using NPM](/Part3/setup#install-openzeppelin)
...
:::danger
The contract name must match the [name of the contract](/Part3/token#defining-the-contract) in the `MyToken.sol` file.
:::
